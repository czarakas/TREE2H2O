...
set job_name       = test_E3SMv1.1BGC_1850_025                               # only used to name the job in the batch system 
set compset        = 1850_CAM5_CLM45%BGC_MPASCICE_DOCN%SOM_MOSART_SGLC_SWAV_TEST
# 1850_CAM5_CLM45%BGC_MPASCICE%SPUNUP_MPASO%SPUNUP_MOSART_SGLC_SWAV   # indicates which model components and forcings to use
# TARGET COMPSET: 1850_CAM5_CLM45%BGC_CICE_DOCN%SOM_MOSART_SGLC_SWAV
# Differences from compset that worked
# Same YEAR, MOSART, SGLC, SWAV
# CAM5 vs. CAM5%CMIP6
# CLM45%BGC vs. CLM45%SPBC
# CICE vs. MPASCICE%SPUNUP
# DOCN%SOM vs. MPASO%SPUNUP
set resolution     = ne30_g16 #ne30_g16 #ne30_oECv3                                        # model resolution to use
...
set case_name      = ${job_name}.f09_g16.cori-kn                        # case name used for archiving etc.
