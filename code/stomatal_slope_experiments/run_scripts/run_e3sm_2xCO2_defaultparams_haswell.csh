...
set job_name       = defaultParams_2xCO2_003                                       # only used to name the job in the batch system 
...
setenv project       m3774                                               # what project code to charge for your run time
...
./xmlchange JOB_WALLCLOCK_TIME=11:20 --subgroup case.run
