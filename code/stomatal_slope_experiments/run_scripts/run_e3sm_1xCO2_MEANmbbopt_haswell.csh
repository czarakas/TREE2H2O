...
set job_name       = mbbopt_mean_1xCO2_003                               # only used to name the job in the batch system 
...
cat <<EOF >> user_nl_clm
 ! finidat
 ! use_init_interp
 paramfile = '/global/homes/c/czarakas/TREE2H2O/code/stomatal_slope_experiments/model_inputs/parameter_files/clm_params_mean.nc'
